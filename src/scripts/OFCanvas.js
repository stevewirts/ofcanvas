...
charMap[189] = ['-', '_'];
charMap[187] = ['=', '+'];
charMap[8] = ['DELETE', 'DELETE_SHIFT'];
charMap[9] = ['TAB', 'TAB_SHIFT'];
charMap[81] = ['q', 'Q'];
charMap[87] = ['w', 'W'];
charMap[69] = ['e', 'E'];
charMap[82] = ['r', 'R'];
...
charMap[221] = [']', '}'];
charMap[220] = ['\\', '|'];
charMap[220] = ['CAPSLOCK', 'CAPSLOCK_SHIFT'];
charMap[65] = ['a', 'A'];
charMap[83] = ['s', 'S'];
charMap[68] = ['d', 'D'];
charMap[70] = ['f', 'F'];
...
charMap[186] = [';', ':'];
charMap[222] = ['\'', '|'];
charMap[13] = ['RETURN', 'RETURN_SHIFT'];
...
charMap[191] = ['/', '?'];
charMap[16] = ['SHIFT', 'SHIFT'];
charMap[17] = ['CTRL', 'CTRL_SHIFT'];
charMap[18] = ['ALT', 'ALT_SHIFT'];
charMap[91] = ['COMMAND_LEFT', 'COMMAND-LEFT_SHIFT'];
charMap[32] = ['SPACE', 'SPACE_SHIFT'];
charMap[93] = ['COMMAND_RIGHT', 'COMMAND-RIGHT_SHIFT'];
charMap[18] = ['ALT', 'ALT_SHIFT'];
charMap[38] = ['UP', 'UP_SHIFT'];
charMap[37] = ['LEFT', 'LEFT_SHIFT'];
charMap[40] = ['DOWN', 'DOWN_SHIFT'];
charMap[39] = ['RIGHT', 'RIGHT_SHIFT'];
